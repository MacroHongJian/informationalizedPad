...
public class PlaneNumberChoose extends AppCompatActivity {
    ...
    private ImageTextVertical[] planes = {new ImageTextVertical("01", 0),
            ...
            new ImageTextVertical("05", 0), new ImageTextVertical("06", 0),
            new ImageTextVertical("07", 0), new ImageTextVertical("08", 0),
            ...
            new ImageTextVertical("37", 0), new ImageTextVertical("其他", 0)};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initPlanes();
        RecyclerView recyclerView = findViewById(R.id.plane_recycler);
